...
# Se connecte à ftp.free.fr sur le port 21 en tant qu'anonyme
...
# Récupère uniquement les dossiers au format JSON
...
# Utilise le parcours en largeur (Breadth-First) pour afficher les permissions
